  ...
  _createClass(App, [{
    ...
    value: function signinEvents() {
      ...
      this.signin.on("signin", function (token) {
        alert(token);
        localStorage.setItem("token", "Berear " + token);
    ...
    value: function signupEvents() {
      ...
      this.signup.on("signup", function () {
    ...
    value: function tasksEvents() {
      ...
      this.tasks.on("error", function (err) {
        return alert(err);
      });
...
var Menu = function (_Task) {
  _inherits(Menu, _Task);
...
},{"../task.js":10,"../templates/footer.js":11}],5:[function(require,module,exports){
"use strict";
...
var Signin = function (_Task) {
  _inherits(Signin, _Task);
...
},{"../task.js":10,"../templates/signin.js":12}],6:[function(require,module,exports){
"use strict";
...
var Signup = function (_Task) {
  _inherits(Signup, _Task);
  ...
  _createClass(Signup, [{
    ...
    value: function formSubmit() {
      ...
      form.addEventListener("submit", function (e) {
        ...
        var email = e.target.querySelector("[data-email]");
        var password = e.target.querySelector("[data-password]");
        var number = e.target.querySelector("[data-number]");
        var opts = {
          method: "POST",
...
},{"../task.js":10,"../templates/signup.js":13}],7:[function(require,module,exports){
"use strict";
...
var TaskForm = function (_Task) {
  _inherits(TaskForm, _Task);
  ...
  _createClass(TaskForm, [{
    ...
    value: function formSubmit() {
      ...
      form.addEventListener("submit", function (e) {
        e.preventDefault();
        var name = e.target.querySelector("[data-name]");
        var body = e.target.querySelector("[data-body]");
        var year = e.target.querySelector("[data-year]");
        var month = e.target.querySelector("[data-month]");
        var day = e.target.querySelector("[data-day]");
        var hour = e.target.querySelector("[data-hour]");
        var min = e.target.querySelector("[data-min]");
        var reHour = e.target.querySelector("[data-rehour]");
        var opts = {
          method: "POST",
...
},{"../task.js":10,"../templates/taskForm.js":14}],8:[function(require,module,exports){
"use strict";
...
var Tasks = function (_Task) {
  _inherits(Tasks, _Task);
...
},{"../task.js":10,"../templates/tasks.js":15}],9:[function(require,module,exports){
"use strict";
...
var User = function (_Task) {
  _inherits(User, _Task);
...
},{"../task.js":10,"../templates/user.js":16}],10:[function(require,module,exports){
"use strict";
...
var Task = function (_TinyEmitter) {
	_inherits(Task, _TinyEmitter);
